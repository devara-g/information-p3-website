...
$result = $conn->query("SELECT * FROM kepsek ORDER BY FIELD(position, 'Kepala Sekolah', 'Wakasek Kurikulum', 'Wakasek Kesiswaan', 'Wakasek Sarana Prasarana', 'Sekretaris', 'Kepala Tata Usaha', 'Staff Tata Usaha'), id ASC");
...
$sections = [
    'kepsek' => ['title' => 'Kepsek & Wakasek', 'positions' => ['Kepala Sekolah', 'Wakasek Kurikulum', 'Wakasek Kesiswaan', 'Wakasek Sarana Prasarana'], 'icon' => 'fa-user-tie', 'color' => '#e74c3c'],
    'sekretaris' => ['title' => 'Sekretaris', 'positions' => ['Sekretaris'], 'icon' => 'fa-user-pen', 'color' => '#9b59b6'],
    'tatausaha' => ['title' => 'Tata Usaha', 'positions' => ['Kepala Tata Usaha', 'Staff Tata Usaha'], 'icon' => 'fa-users-cog', 'color' => '#3498db']
];
