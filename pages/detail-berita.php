...
.db-hero-meta-item i { color: #0ac4e0; font-size: 0.9rem; }
.db-author-chip {
    display: flex;
    align-items: center;
    gap: 10px;
...
.db-hero-scroll-hint i { font-size: 1rem; }
...
.db-wave-wrap svg { display: block; width: 100%; }
...
@media (max-width: 768px) {
    .db-layout { padding: 0 1rem; margin-bottom: 3rem; }
}
...
.db-back-btn i { font-size: 0.8rem; }
.db-kat-badge {
    display: inline-flex;
    align-items: center;
    gap: 6px;
...
.db-feat-img-wrap:hover img { transform: scale(1.04); }
.db-feat-img-overlay {
    position: absolute;
    inset: 0;
...
@media (max-width: 768px) {
    .db-article-body { padding: 1.5rem; }
    .db-article-nav { padding: 1rem 1.5rem; }
}
...
.db-share-label i { color: var(--primary); }
.db-share-btns {
    display: flex;
    gap: 10px;
}
...
.db-share-btn:hover::before { transform: scaleX(1); }
.db-share-btn:hover {
    transform: translateY(-4px);
    box-shadow: 0 8px 20px rgba(0,0,0,0.2);
    color: #fff;
}
.db-share-btn.fb  { background: #1877f2; }
.db-share-btn.tw  { background: #1da1f2; }
.db-share-btn.wa  { background: #25d366; }
.db-share-btn.lnk { background: var(--primary); }
.db-copy-toast {
...
/* Recommended list */
.db-rec-list { display: flex; flex-direction: column; gap: 0; }
.db-rec-item {
    display: flex;
    gap: 14px;
    padding: 1rem 0;
...
.db-rec-item:hover::before { opacity: 1; }
.db-rec-item:hover { transform: translateX(6px); }
.db-rec-item:last-child { border-bottom: none; padding-bottom: 0; }
.db-rec-img-wrap {
...
.db-rec-item:hover .db-rec-img-wrap img { transform: scale(1.1); }
.db-rec-no-img {
    width: 100%; height: 100%;
    background: var(--gradient-primary);
    display: flex; align-items: center; justify-content: center;
...
.db-rec-info { display: flex; flex-direction: column; justify-content: center; }
.db-rec-cat {
...
.db-rec-item:hover .db-rec-title { color: var(--primary); }
.db-rec-date {
...
.db-newsletter .db-widget-title { color: #fff; }
.db-newsletter .db-widget-title-bar { background: #0ac4e0; }
.db-newsletter p {
...
.db-nl-input::placeholder { color: rgba(255,255,255,0.35); }
.db-nl-input:focus { border-color: #0ac4e0; }
.db-nl-btn {
...
@media (min-width: 1025px) {
    .db-sidebar { position: sticky; top: 8rem; align-self: start; }
}

/* Responsive */
@media (max-width: 768px) {
    .db-hero { min-height: 65vh; padding-bottom: 6rem; }
    .db-hero-title { font-size: 1.7rem; }
    .db-share-section { flex-direction: column; align-items: flex-start; }
    .db-cta-inner { flex-direction: column; text-align: center; }
    .db-cta-inner::before { display: none; }
    .db-author-card { flex-direction: column; text-align: center; }
...
<div class="db-layout">
    ...
    <aside class="db-sidebar">
        ...
        <div class="db-sidebar-widget">
            ...
            <?php mysqli_data_seek($result_recommend, 0); while ($rec = mysqli_fetch_assoc($result_recommend)): ?>
